...
- Per-recipient **`current_segment`** on `StateUpdate` projects the active arc segment (`allowed_actions`, owner, `ui_mode`) for dock affordances and client draft entry
