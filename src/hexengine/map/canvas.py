...
class SVGCanvas:
    ...
    def __init__(self, svg_element: js.SVGElement, hex_layout: HexLayout, hex_color: str, hex_stroke:int):
...
class MapCanvas:
    ...
    """
    def __init__(self, canvas_element: str, hex_layout: HexLayout, hex_color: str, hex_stroke:int):  
    ...
    def draw_line(self, x1: float, y1: float, x2: float, y2: float, stroke="black", stroke_width=1):
...
class Map:
    ...
    def __init__(self, 
        ...
        self._svg = SVGCanvas(svg_element, self._hex_layout, self._hex_color, self._hex_stroke)
