...
class TurnState:
    ...
    def with_actions_spent(self, amount: int = 1) -> "TurnState":
        ...
        return replace(self, phase_actions_remaining=self.phase_actions_remaining - amount)
    
    def with_next_phase(self, new_faction: str, new_phase: str, max_actions: int) -> "TurnState":
...
class GameState:
    ...
    and contains no display or UI concerns. Perfect for:
    ...
    @classmethod
    def create_empty(cls, initial_faction: str = "Blue", initial_phase: str = "Movement") -> "GameState":
