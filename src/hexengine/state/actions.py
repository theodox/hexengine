"""
State-based actions for the new immutable state system.

These actions work with GameState (immutable) instead of mutating GameBoard.
The old Action protocol is kept for backward compatibility during migration.
"""
...
class AddUnit:
    ...
    def __init__(self, unit_id: str, unit_type: str, faction: str, position: "Hex", health: int = 100):
        self.unit_id = unit_id
