...
class StateAction(Protocol):
    """Protocol for actions that modify game state.
    
    Actions are pure functions: they take a state and return a new state.
    They don't mutate anything directly.
    """
...
class ActionManager:
    ...
    - Complete action history for undo/redo
    - Observer notifications for display updates
    """
