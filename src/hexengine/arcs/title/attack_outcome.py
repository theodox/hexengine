"""Normalize resolve_attack results and collect post-attack bucket follow-ups."""
...
def follow_up_state_actions_after_attack(
    ...
    *,
    ...
    Priority: CombatOutcome from resolve_attack, then COMBAT_OUTCOME_AFTER_APPLIED.
    """
