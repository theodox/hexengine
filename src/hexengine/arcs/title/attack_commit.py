"""
Shared Attack commit helpers for arc effects and previews (title allowlist).

Titles bind attack_arc_effect on the overlay graph; these helpers normalize wire,
run interaction validate/resolve, and build StateAction lists without importing
hexengine.server.
"""
