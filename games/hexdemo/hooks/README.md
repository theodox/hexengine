...
```text
MoveUnit / movement arc  →  MovementHook.*  →  hooks/movement.py  →  ../movement_rules.py (+ ../combat.py retreat reads)
...
| `../combat.py` — retreat obligation reads | `movement_rules`, `combat_rules` |
